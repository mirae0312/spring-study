	...
	<form name="memberEnrollFrm" action="" method="POST">
		<table class="mx-auto">
			...
			<tr>
				<th>생년월일</th>
				<td>	
					<input type="date" class="form-control" name="birthday" id="birthday" value="1999-03-03"/>
				</td>
			</tr> 
			<tr>
				<th>이메일</th>
			...
			<tr>
				<th>주소</th>
				<td>	
					<input type="text" class="form-control" placeholder="" name="address" id="address" value="인천시 서구">
				</td>
			</tr>
			<tr>
				<th>성별 </th>
