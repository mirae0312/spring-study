...
<div id="demo-container" 
	...
	<form id="devFrm" method="POST">
		<input type="hidden" name="token" value="as234dhasdsdas12345" />
		<div class="form-group row">
		  <label for="name" class="col-sm-2 col-form-label">이름</label>
		  <div class="col-sm-10">
		    <input type="text" class="form-control" id="name" name="name" value="신사임당" required>
		  </div>
		</div>
		<div class="form-group row">
		...
		<div class="form-group row">
		  ...
		  <div class="col-sm-10">
		    <input type="email" class="form-control" id="email" name="email" value="sinsa@gmail.com"required>
		  </div>
		</div>
	...
	<div class="list-group">
	  ...
	  <button type="button" onclick="submit('insertDev');" class="list-group-item list-group-item-action">Database - insert</button>
	</div>
</div>
<script>
const submit = (name) => {
	$(devFrm)
		.attr("action", `${pageContext.request.contextPath}/demo/\${name}.do`)
		.submit();
};
